...
<div class="p-2" style="width: 300px ">
    <?= $form1->field($mymodel, 'egresoid')
        ->dropdownList($listaEgresado,['prompt'=>'Seleccione','options'=>[$seleccionEgresado=>['selected'=>true]]]);
    ?>
</div>
...
<div class="row">
    <div class="col">  Por estudiantes por lugar de egreso seleccionado:</div>
</div>
<div id="feedback">
