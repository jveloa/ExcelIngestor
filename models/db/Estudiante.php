    ...
    class Estudiante extends \yii\db\ActiveRecord{
            ...
            return [
                [
                    [
                        ...
                        'indice_academico',
                        'id_dato_militar',
                        'id_integracion_politica',
                        'id_experiencia_direccion',
                        'becado',
                        'cantidad_hijos',
                        'estado_civil',
                        'id_convivencia',
                        'id_dependencia_economica',
                        'id_sector_ocupacional_padre',
                        'id_sector_ocupacional_madre',
                        'id_nivel_escolaridad_padre',
                        'id_nivel_escolaridad_madre',
                        'informar_familia',
                        'id_contacto',
                        'carerra_opcion'
                    ],
                ...
                [
                    ...
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => Convivencia::className(),
                    'targetAttribute' => ['id_convivencia' => 'id']
                ],
                [
                    ['id_dato_militar'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => DatoMilitar::className(),
                    'targetAttribute' => ['id_dato_militar' => 'id']
                ],
                [
                    ['id_dependencia_economica'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => DependenciaEconomica::className(),
                    'targetAttribute' => ['id_dependencia_economica' => 'id']
                ],
                [
                    ['id_egresado'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => EgresadoDe::className(),
                    'targetAttribute' => ['id_egresado' => 'id']
                ],
                [
                    ['estado_civil'],
                    'exist',
                    ...
                    'targetAttribute' => ['estado_civil' => 'id']
                ],
                [
                    ['id_experiencia_direccion'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => ExperienciaDireccion::className(),
                    'targetAttribute' => ['id_experiencia_direccion' => 'id']
                ],
                [
                    ['id_ingreso'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => Ingreso::className(),
                    'targetAttribute' => ['id_ingreso' => 'id']
                ],
                [
                    ['id_integracion_politica'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => IntegracionPolitica::className(),
                    'targetAttribute' => ['id_integracion_politica' => 'id']
                ],
                [
                    ['id_municipio'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => Municipio::className(),
                    'targetAttribute' => ['id_municipio' => 'id']
                ],
                [
                    ['id_nivel_escolaridad_padre'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => NivelEscolaridad::className(),
                    'targetAttribute' => ['id_nivel_escolaridad_padre' => 'id']
                ],
                [
                    ['id_nivel_escolaridad_madre'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => NivelEscolaridad::className(),
                    'targetAttribute' => ['id_nivel_escolaridad_madre' => 'id']
                ],
                [
                    ['id_sector_ocupacional_padre'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => SectorOcupacional::className(),
                    'targetAttribute' => ['id_sector_ocupacional_padre' => 'id']
                ],
                [
                    ['id_sector_ocupacional_madre'],
                    'exist',
                    'skipOnError'     => true,
                    'targetClass'     => SectorOcupacional::className(),
                    'targetAttribute' => ['id_sector_ocupacional_madre' => 'id']
                ],
            ];
        }
        ...
        public function attributeLabels(){
            return [
                ...
                'id_egresado'                 => 'Id Egresado',
                'id_ingreso'                  => 'Id Ingreso',
                'nota_matematica'             => 'Nota Matematica',
                'nota_espannol'               => 'Nota Espannol',
                'nota_historia'               => 'Nota Historia',
        ...
        public function getContacto(){
            return $this->hasOne(Contacto::className(), ['carné_estudiante' => 'carné']);
        }
        ...
        public function getConvivencia(){
            return $this->hasOne(Convivencia::className(), ['id' => 'id_convivencia']);
        }
        ...
        public function getDatoMilitar(){
            return $this->hasOne(DatoMilitar::className(), ['id' => 'id_dato_militar']);
        }
        ...
        public function getDependenciaEconomica(){
            return $this->hasOne(DependenciaEconomica::className(), ['id' => 'id_dependencia_economica']);
        }
        ...
        public function getEgresado(){
            return $this->hasOne(EgresadoDe::className(), ['id' => 'id_egresado']);
        }
        ...
        public function getEstudianteAspectoProfesion(){
            return $this->hasOne(EstudianteAspectoProfesion::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getEstudianteDeporteArtes(){
            return $this->hasMany(EstudianteDeporteArte::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getEstudianteInteres(){
            return $this->hasOne(EstudianteInteres::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getEstudiantePregResps(){
            return $this->hasMany(EstudiantePregResp::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getExperienciaCarreras(){
            return $this->hasMany(ExperienciaCarrera::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getExperienciaDireccion(){
            return $this->hasOne(ExperienciaDireccion::className(), ['id' => 'id_experiencia_direccion']);
        }
        ...
        public function getFactorIngresoCarreras(){
            return $this->hasMany(FactorIngresoCarrera::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getFormaEstudio(){
            return $this->hasOne(FormaEstudio::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getHabitos(){
            return $this->hasOne(Habitos::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getHorasDedicadas(){
            return $this->hasOne(HorasDedicadas::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getIngreso(){
            return $this->hasOne(Ingreso::className(), ['id' => 'id_ingreso']);
        }
        ...
        public function getIntegracionPolitica(){
            return $this->hasOne(IntegracionPolitica::className(), ['id' => 'id_integracion_politica']);
        }
        ...
        public function getNivelEscolaridadMadre(){
            return $this->hasOne(NivelEscolaridad::className(), ['id' => 'id_nivel_escolaridad_madre']);
        }
        ...
        public function getNivelEscolaridadPadre(){
            return $this->hasOne(NivelEscolaridad::className(), ['id' => 'id_nivel_escolaridad_padre']);
        }
        ...
        public function getParticipacionConcursos(){
            return $this->hasMany(ParticipacionConcurso::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getRazonIngresoCarreras(){
            return $this->hasMany(RazonIngresoCarrera::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getRol(){
            return $this->hasOne(Rol::className(), ['id_estudiante' => 'carné']);
        }
        ...
        public function getSectorOcupacionalMadre(){
            return $this->hasOne(SectorOcupacional::className(), ['id' => 'id_sector_ocupacional_madre']);
        }
        ...
        public function getSectorOcupacionalPadre(){
            return $this->hasOne(SectorOcupacional::className(), ['id' => 'id_sector_ocupacional_padre']);
        }
    }
